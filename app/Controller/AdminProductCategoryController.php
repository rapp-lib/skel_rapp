 ...
 * @controller
 */
class AdminProductCategoryController extends Controller_Admin
{
    /**
     * 検索フォーム
     */
    protected static $form_search = array(
        "receive_all" => true,
        "search_page" => "admin_product_category.list",
        "search_table" => "ProductCategory",
        "fields" => array(
    ...
    protected static $form_entry = array(
        "form_page" => "admin_product_category.form",
        "csrf_check" => true,
        "table" => "ProductCategory",
        "fields" => array(
            "id"=>array("label"=>"ID"),
            "kind"=>array("label"=>"種類"),
            "parent_id"=>array("label"=>"大分類ID"),
    ...
    {
        if ($id = $this->input["id"]) {
            table("ProductCategory")->deleteById($id);
        }
        return $this->redirect("id://admin_product_category.list", array("back"=>"1"));
    }
}
