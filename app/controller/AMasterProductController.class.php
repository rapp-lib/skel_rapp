...
class AMasterProductController extends Controller_App
{
    ...
    public function act_view_list ()
    {
        ...
        list($this->vars["ts"] ,$this->vars["p"]) = table("Product")            ->findBySearchForm($this->list_setting, $this->c->input())
            ->selectPagenate();
    }
    ...
    public function act_entry_form ()
    {
        ...
        if ($_REQUEST["id"]) {
            ...
            $t =table("Product")->selectById($this->c->id());
    ...
    public function act_view_csv ()
    {
        ...
        $res =table("Product")                ->findBySearchForm($this->list_setting,$this->c->input())
                ->removePagenation()
                ->selectNoFetch();
